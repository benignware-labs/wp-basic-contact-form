    ...
    <form class="bcf-form" method="POST">
      <?php if (in_array('name', $fields)) : ?>
        <p class="bcf-field">
          ...
          <input class="bcf-input<?= $errors['name'] ? ' is-invalid' : '' ?>" placeholder="<?= __('Please enter your name', 'basic-contact-form') ?>" type="text" name="name" size="50" maxlength="80" value="<?= $data['name'] ?>" />
      ...
      <?php if (in_array('email', $fields)) : ?>
        <p class="bcf-field">
          ...
          <input class="bcf-input<?= $errors['email'] ? ' is-invalid' : '' ?>" placeholder="<?= __('Please enter your e-mail address', 'basic-contact-form') ?>" type="email" name="email" size="50" maxlength="80" value="<?= $data['email'] ?>" />
      ...
      <?php if (in_array('subject', $fields)) : ?>
        <p class="bcf-field">
          ...
          <input class="bcf-input<?= $errors['subject'] ? ' is-invalid' : '' ?>" placeholder="<?= __('Please enter a subject', 'basic-contact-form') ?>" type="text" name="subject" size="50" maxlength="256" value="<?= $data['subject'] ?>" />
      ...
      <?php if (in_array('message', $fields)) : ?>
        <p class="bcf-field">
          ...
          <textarea class="bcf-input<?= $errors['message'] ? ' is-invalid' : '' ?>" placeholder="<?= __('Please describe what your inquiry is about', 'basic-contact-form') ?>" name="message" size="50" rows="8"><?= $data['message'] ?></textarea>
