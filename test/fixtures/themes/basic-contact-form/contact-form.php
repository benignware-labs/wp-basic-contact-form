    ...
    <form class="contact-form" method="POST">
      <?php if (in_array('name', $fields)) : ?>
        <p class="contact-field form-group">
          ...
          <input class="form-control contact-input contact-name<?= $errors['name'] ? ' is-invalid' : '' ?>" placeholder="<?= __('Please enter your name', 'basic-contact-form') ?>" type="text" name="name" size="50" maxlength="80" value="<?= $data['name'] ?>" />
      ...
      <?php if (in_array('email', $fields)) : ?>
        <p class="contact-field form-group">
          ...
          <input class="form-control contact-input contact-email<?= $errors['email'] ? ' is-invalid' : '' ?>" placeholder="<?= __('Please enter your e-mail address', 'basic-contact-form') ?>" type="text" name="email" size="50" maxlength="80" value="<?= $data['email'] ?>" />
      ...
      <?php if (in_array('subject', $fields)) : ?>
        <p class="contact-field form-group">
          ...
          <input class="form-control contact-input contact-subject<?= $errors['subject'] ? ' is-invalid' : '' ?>" placeholder="<?= __('Please enter a subject', 'basic-contact-form') ?>" type="text" name="subject" size="50" maxlength="256" value="<?= $data['subject'] ?>" />
      ...
      <?php if (in_array('message', $fields)) : ?>
        <p class="contact-field form-group">
          ...
          <textarea class="form-control contact-input contact-message<?= $errors['message'] ? ' is-invalid' : '' ?>" placeholder="<?= __('Please describe what your inquiry is about', 'basic-contact-form') ?>" name="message" size="50" rows="8"><?= $data['message'] ?></textarea>
